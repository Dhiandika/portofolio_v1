...
const site = defineCollection({
    ...
    schema: z.object({
        ...
        profileName_id: z.string().optional().nullable(),
        // bio & bio_id defined above (Hero section) — shared field
        coverBanner: z.string().optional().nullable(),
        showMarquee: z.boolean().optional(),
        marqueeText: z.string().optional().nullable(),
        marqueeText_id: z.string().optional().nullable(),
        showVCard: z.boolean().optional(),
        vcardEmail: z.string().optional().nullable(),
        vcardPhone: z.string().optional().nullable(),
        vcardJobTitle: z.string().optional().nullable(),
        showSearchBar: z.boolean().optional(),
        showCategoryFilter: z.boolean().optional(),
        showSocials: z.boolean().optional(),
        themePreset: z.enum(['default', 'cyberpunk', 'retro']).optional(),
        avatar: z.string().optional().nullable(),
        statusBadge: z.string().optional().nullable(),
        statusBadge_id: z.string().optional().nullable(),
        links: z.array(z.object({
            ...
            category: z.enum(['Main', 'Creation', 'Portfolio', 'Resources', 'Contact']).optional(),
            gridSize: z.enum(['full', 'half']).optional(),
            isHighlighted: z.boolean().optional(),
            isActive: z.boolean().optional(),
            description: z.string().optional().nullable(),
            description_id: z.string().optional().nullable(),
            // Advanced per-link features
        ...
        showFeaturedProject: z.boolean().optional(),
        showFeaturedBlog: z.boolean().optional(),
        showCuratedBrands: z.boolean().optional(),
        showCuratedDesigns: z.boolean().optional(),
        featuredProject: z.string().optional().nullable(),
        featuredBlog: z.string().optional().nullable(),
        featuredBrands: z.array(z.string()).optional().nullable(),
        featuredDesigns: z.array(z.string()).optional().nullable(),
        // Analytics & Advanced Feature Toggles
        showClickCount: z.boolean().optional(),
        enableUTMTracking: z.boolean().optional(),
